...
DF1motif_vec <- function(DF1_start){
...
DF1_motif_vec <- function(pos_m6A_seq,neg_m6A_seq){
  pos_m6A_DF1 <- get_DF1_motif_infor(peak_seq=pos_m6A_seq)
  neg_m6A_DF1 <- get_DF1_motif_infor(peak_seq=neg_m6A_seq)
  pos_DF1motif_vec <- DF1motif_vec(DF1_start=pos_m6A_DF1$DF1motif_start)
  neg_DF1motif_vec <- DF1motif_vec(DF1_start=neg_m6A_DF1$DF1motif_start)
  DF1_motif_vec_list <- list(pos_DF1motif_vec=pos_DF1motif_vec,neg_DF1motif_vec=neg_DF1motif_vec)
  return(DF1_motif_vec_list)
}
